...
//  PayUp
//
//  Created by Rychillie Umpierre de Oliveira on 21/09/25.
//
...
//        field.font = Fonts.paragraphMedium()
    ...
    private let type: InputTextFieldTypes
    
    init(title: String, placeholder: String, type: InputTextFieldTypes = .normal) {
        self.type = type
